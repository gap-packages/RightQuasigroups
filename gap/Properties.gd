...
#! <Item><Index>diassociative magma</Index>**diassociative**: every submagma generated by two elements is associative</Item>
...
#! <Item><Index>power associative magma</Index>**power associative**: every submagma generated by a single element is associative</Item>
...
#! @BeginGroup
#! @GroupTitle Testing properties of magmas and right quasigroups
...
#! @Arguments Q
DeclareProperty( "IsAssociative", IsRightQuasigroup ); # exists for magmas

#! @Arguments Q
DeclareProperty( "IsCommutative", IsRightQuasigroup ); # exists for magmas

#! @Arguments Q
DeclareProperty( "IsDiassociative", IsMagma );
...
#! @Arguments Q
DeclareProperty( "IsPowerAssociative", IsMagma );
...
# UPDATE POINT: review implications when new properties are added
...
InstallTrueMethod( Is3PowerAssociative, IsFlexible ); 
...
InstallTrueMethod( IsDiassociative, IsAssociative );
